...
OutputBaseFilename=RStudio-3.0-setup
...
[Run]
Filename: "{app}\bin\RStudio.exe"; Description: "Launch RStudio 3.0"; Flags: nowait postinstall skipifsilent
